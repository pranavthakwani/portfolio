  ...
  return (
    <main className="min-h-screen bg-slate-950 px-4 py-6 text-slate-100 sm:px-7 lg:px-10">
      ...
      <div className="mx-auto max-w-[1500px] py-7">
        ...
        <section className="mt-5"><HeatmapExplorer clicks={heatClicks} attention={attention.map((section) => ({ section: section.name, averageMs: section.dwellMs / section.dwellSamples, samples: section.dwellSamples }))} /></section>
